...
import { List, X, Wallet, ArrowRight } from "@phosphor-icons/react";
        ...
        <nav className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6 md:hidden">
            ...
            <div className="flex items-center gap-2">
                ...
                <Sheet open={open} onOpenChange={setOpen}>
                    ...
                    <SheetContent side="right" className="w-[92vw] rounded-l-3xl sm:w-105">
                        <SheetHeader className="space-y-3">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Budget around real paydays and priorities.
                            </p>
                        </SheetHeader>
                        ...
                        <div className="mt-6 space-y-3">
                            {links.map((l) => (
                                <a
                                    ...
                                    href={l.href}
                                    onClick={() => setOpen(false)}
                                    className="block rounded-2xl border border-border/50 bg-foreground/2 px-4 py-3 transition-colors hover:bg-foreground/4"
                                >
